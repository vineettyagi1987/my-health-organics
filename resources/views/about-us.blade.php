...
<div class="container my-5">
    ...
    <div class="text-center mb-5">
        <h1 class="fw-bold text-success">🌿 Save The Nature Trust (STNT)</h1>
   ...
   <section class="about-section">
    ...
    <p>
        Nature is the foundation of life, and the well-being of humanity is deeply connected 
        to the health of our environment. In recent years, we have witnessed rapid environmental 
        degradation, increasing pollution, unhealthy lifestyles, and a gradual decline in cultural 
        and human values.
    </p>
    ...
    <p>
        ...
        together scientists, professionals, educators, and socially responsible individuals to work 
        toward protecting nature and promoting sustainable living.
    </p>

    <p>
        Our goal is not only to preserve the environment but also to create a society that respects 
        natural resources, values health and well-being, and upholds ethical and cultural principles.
    </p>
    ...
    <p>
        ...
        dedicated efforts from individuals and communities.
    </p>

    <p>
        Together, we can create a healthier planet and a better future for generations to come.
    </p>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="section-box">
                ...
                <p>
                   “Healthier Planet and Better Future”. Promoting scientific innovation, conscious and
sustainable development for the benefit of human health, build a sustainable and
environmentally conscious society where people live in harmony with nature, adopt sustainable
lifestyles, and uphold strong cultural and ethical values. We aim to create a future in which
environmental protection, ethical values, and cultural heritage are preserved.
                </p>
            </div>
        </div>
...
participation, and traditional wisdom.
  ...
  <div class="card shadow-sm p-4 mb-5">
    ...
    <p>
        The Advisory Board of <strong>Save The Nature Trust (STNT)</strong> consists of experienced 
        professionals, scientists, educators, and socially responsible individuals who volunteer 
        their knowledge and expertise to guide the Trust in achieving its mission and vision.
    </p>

    <p>
        The board provides strategic advice, scientific and technical insight, and independent 
        perspectives to help strengthen the Trust’s initiatives and long-term goals.
    </p>

    <p>
        By supporting the planning and implementation of programs related to environmental 
        conservation, sustainable agriculture, health and wellness, renewable energy awareness, 
        and community education, the Advisory Board plays an important role in ensuring that the 
        organization’s activities remain impactful, credible, and aligned with its core values.
    </p>

    <p>
        Through their guidance and commitment, the Advisory Board helps STNT promote responsible 
        stewardship of natural resources and encourages collaborative efforts toward building a 
        healthier, environmentally conscious, and sustainable society for future generations.
    </p>
...
community development, and sustainable living.</p>
    ...
    <p>
        We encourage the cultivation and consumption of organic food to promote healthy lifestyles 
        and sustainable farming. Our organization provides training programs for farmers led by 
    ...
    <p>
        ...
        farming techniques that protect food and soil from harmful chemical pollutants, helping to 
        restore human health, animal health, and soil health.
    </p>
    ...
    <p>
        To promote organic and natural foods, protect soil, flora and fauna, and encourage a 
        healthy lifestyle, we organize environmental awareness campaigns, tree plantation drives, 
        and educational workshops. These initiatives aim to conserve natural resources and 
    ...
    <p>
        We support holistic health and disease prevention by facilitating guidance from qualified 
        yoga instructors and Ayurvedic practitioners. These initiatives aim to promote physical, 
        mental, and emotional well-being in communities.
    </p>
 ...
 <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                Our organization promotes the use of renewable energy sources such as solar power 
                appliances for regular use and encourages environmentally friendly technologies to 
                reduce pollution and support a healthier, pollution-free life. We also facilitate 
          ...
          <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                We provide career guidance, educational counselling, and mentorship for students 
                through monthly online sessions conducted by experienced professors, scientists, 
                and subject experts. Our goal is to help young individuals build strong academic 
          ...
          <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                We actively promote Indian cultural values, ethics, and humanitarian principles 
                through educational programs, seminars, workshops, and training camps that 
                encourage responsible citizenship and social harmony.
            </p>
...
<div class="row g-4 mt-2">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                Volunteers are an essential part of our mission. We welcome individuals 
                passionate about health, environment, education, and community development.
            </p>
            ...
            <p class="small text-muted">
                Contribute your skills and create a positive social impact.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                Join our network and actively support our mission while benefiting from 
                our services and initiatives.
            </p>

            <ul>
                <li>Access our services and products</li>
                <li>Refer and promote initiatives</li>
                <li>Participate in programs</li>
                <li>Promote sustainable practices</li>
                <li>Share expertise (science, health, education, tech)</li>
            </ul>

            <p class="small text-muted">
                Membership strengthens a sustainable and healthier future for society.
            </p>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm p-4 h-100">
            ...
            <p>
                ...
                development programs and environmental initiatives.
            </p>
            ...
            <ul>
                ...
                <li>International sustainability groups</li>
...
<div class="card shadow-sm p-4 mt-4">
    ...
    <p>
        To expand our impact, we seek partnerships and funding from organizations aligned 
        with environmental sustainability and social development.
    </p>

    <ul>
        <li>Environmental awareness and conservation programs</li>
        <li>Farmer training in organic agriculture</li>
        <li>Renewable energy awareness</li>
        <li>Education and career guidance</li>
        <li>Community health initiatives</li>
        <li>Organic food initiatives</li>
    </ul>

    <p class="text-muted small">
        All funding is utilized responsibly and transparently.
    </p>
...
<div class="card shadow-sm p-4 mt-4 text-center">
    ...
    <div class="card shadow-sm p-4 mt-4 text-center">
        ...
        <p>
            ...
            educators, and social contributors who share a strong commitment toward protecting 
            human health, environmental sustainability, knowledge dissemination, and social development.
        </p>

        <p>
            As part of our efforts to empower individuals and communities, STNT has established a 
            group of volunteer faculty members (both national and international) who provide guidance 
            in education and career development through monthly online sessions.
        </p>

        <p>
            These sessions are typically conducted on the last Sunday of every month (schedule 
            available on our website). Our experienced mentors offer valuable insights, academic 
            direction, and professional advice to help members make informed decisions about their 
            educational and career paths.
        </p>

        <p>
            The career guidance and education counselling services provided by these volunteer 
            faculties are exclusively designed for members of Save The Nature Trust.
        </p>

        <p>
            Through this initiative, STNT aims to support personal growth, promote responsible 
            leadership, and encourage the next generation to contribute meaningfully toward a 
    ...
    <!-- CORE MEMBERS -->
     <div class="card shadow-sm p-4 mt-4 text-center">
        ...
        <p class="text-muted">
            The core members of Save The Nature Trust (STNT) are committed individuals who 
            share a vision of protecting nature, promoting sustainable living, and strengthening 
            human health and environmental responsibility.
        </p>
